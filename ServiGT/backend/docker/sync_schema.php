...
// ── Corregir tildes/ñ en categorias sembradas antes de este cambio ─────────
$renombresCategorias = [
    'Plomeria'    => ['Plomería',    'Servicios de plomería y fontanería'],
    'Electricidad' => ['Electricidad', 'Instalaciones y reparaciones eléctricas'],
...
$updateCategoria = $pdo->prepare('UPDATE categorias SET nombre = :nombre, descripcion = :descripcion WHERE nombre = :old');
foreach ($renombresCategorias as $old => [$nombre, $descripcion]) {
    $updateCategoria->execute(['nombre' => $nombre, 'descripcion' => $descripcion, 'old' => $old]);
}
